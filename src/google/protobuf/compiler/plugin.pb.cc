...
const ::_pbi::TcParseTable<3, 4, 2, 79, 2> CodeGeneratorRequest::_table_ = {
  {
    ...
    {::_pbi::FieldAuxDefaultMessage{}, &::PROTOBUF_NAMESPACE_ID::compiler::_Version_default_instance_},
...
const ::_pbi::TcParseTable<2, 4, 1, 86, 2> CodeGeneratorResponse_File::_table_ = {
  {
    ...
    {::_pbi::FieldAuxDefaultMessage{}, &::PROTOBUF_NAMESPACE_ID::_GeneratedCodeInfo_default_instance_},
  }}, {{
    "\63\4\17\7\0\0\0\0"
...
const ::_pbi::TcParseTable<2, 3, 1, 60, 2> CodeGeneratorResponse::_table_ = {
  {
    ...
    {::_pbi::FieldAuxDefaultMessage{}, &::PROTOBUF_NAMESPACE_ID::compiler::_CodeGeneratorResponse_File_default_instance_},
  }}, {{
    "\56\5\0\0\0\0\0\0"
